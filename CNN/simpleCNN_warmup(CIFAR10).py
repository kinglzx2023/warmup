...
for epoch in range(num_epochs):
    ...
    print(f'Epoch [{epoch + 1}/{num_epochs}], Loss: {train_loss:.4f}, Train Accuracy: {train_accuracy:.4f}, Test Accuracy: {test_accuracy:.4f}'+'  '+'Lr:'+str(round(scheduler.get_last_lr()[0],6)))
